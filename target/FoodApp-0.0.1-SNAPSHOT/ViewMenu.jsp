				...
				success:function(data){
					...
					/* if(data!=null)
						...
						for(var i=0;i<orderedMenu.length;i++)
							{
							$("#orderedElement").append="<div>"+orderedMenu.value+"</div>";
							}
						console.log(data);
						$("#menuitems").hide();
						$("#viewItems").show();
	...
	<div class="row">
		...
		<c:forEach var="menu" items="${MENUNAME}">
			<div class="cont col-md-4">
				<img class="cont-img img-display" src="${menu.image}" alt=""> <span
...
<br>
<div class="amount">
<div id="finalAmount">Rs. 700</div>
<div id="restaurentCharges">Rs. 700</div>
<div>Delivery Charge: Rs.25</div>
<div id="totalAmount">Total Charge: Rs.000</div>
